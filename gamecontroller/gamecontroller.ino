...
const char* const names[] = {"Jessometer", "Nolanator", "Kentoscope", "Shields", "Engines", "Perley", "Poweball", "Gyroscope", "Hyperdrive"};
const char* const commands[] = {"Set Jessometer to %s position",
                          "Slide Nolanator to %s",
                          "Tilt Kentoscope %s degrees",
                          "Activate the %s Shields",
                          "Cool down %s Engine."
                          "Turn %s Perley",
                          "%s the Powerball",
                          "Turn Gyropscope to %s",
                          "Set hyperdrive to level %s"};
